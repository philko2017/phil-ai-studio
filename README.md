...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    ...
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">時數引路人</strong>
    <p style="font-size: 0.9em; color: #666; line-height: 1.4;">上傳數字截圖，獲得專屬的易卦與天使啟示</p>
    <a href="https://share.gemini.google/ovNKRTnl7bUv" target="_blank" style="text-decoration: none; color: #0366d6;">🚀 啟動專案</a>
  </div>
</td>
<td width="33%" valign="top">
...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    ...
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">🎮 彩虹卡解讀助手</strong>
    <p style="font-size: 0.9em; color: #666; line-height: 1.4;"></p>
...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    <span style="font-size: 0.8em; background: #f0f0f0; padding: 2px 6px; border-radius: 4px;">寫作</span><br>
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">📝 會議記錄提示詞庫</strong>
    <p style="font-size: 0.9em; color: #666; line-height: 1.4;"></p>
...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    <span style="font-size: 0.8em; background: #f0f0f0; padding: 2px 6px; border-radius: 4px;">寫作</span><br>
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">✍️ Podcast 企劃提示詞庫</strong>
    <p style="font-size: 0.9em; color: #666; line-height: 1.4;"></p>
...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    ...
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">🖼️ 形象照產生器</strong>
...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    ...
    <p style="font-size: 0.9em; color: #666; line-height: 1.4;">經典遊戲</p>
...
<td width="33%" valign="top">
  <img src="./images/34af417a-df99-8043-aaa0-d2fa310e628a.png" width="100%" style="border-radius:10px; border: 1px solid #eee;">
  <br>
  <div style="padding: 10px 0;">
    <span style="font-size: 0.8em; background: #f0f0f0; padding: 2px 6px; border-radius: 4px;">圖片</span><br>
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">🖼️ 運動雜誌封面產生器</strong>
...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    <span style="font-size: 0.8em; background: #f0f0f0; padding: 2px 6px; border-radius: 4px;">圖片</span><br>
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">🛍️ 電商商品展示圖片產生器</strong>
...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    <span style="font-size: 0.8em; background: #f0f0f0; padding: 2px 6px; border-radius: 4px;">寫作</span><br>
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">✍️ 春節親戚靈魂拷問生存模擬器</strong>
    <p style="font-size: 0.9em; color: #666; line-height: 1.4;">輸入長輩那句讓你翻白眼的話，選擇優雅（或火爆）回擊</p>
    <a href="https://gemini.google.com/share/aee4dbd6e9d0" target="_blank" style="text-decoration: none; color: #0366d6;">🚀 啟動專案</a>
  </div>
</td>
<td width="33%" valign="top">
  <img src="./images/342f417a-df99-8049-88bd-c6afff9abacc.png" width="100%" style="border-radius:10px; border: 1px solid #eee;">
  <br>
  <div style="padding: 10px 0;">
    <span style="font-size: 0.8em; background: #f0f0f0; padding: 2px 6px; border-radius: 4px;">圖片</span><br>
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">🖼️ 早安圖產生器</strong>
...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    <span style="font-size: 0.8em; background: #f0f0f0; padding: 2px 6px; border-radius: 4px;">圖片</span><br>
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">🖼️ LINE 貼圖角色產生器</strong>
...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    <span style="font-size: 0.8em; background: #f0f0f0; padding: 2px 6px; border-radius: 4px;">圖片</span><br>
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">🖼️ 韓劇感的個人藝術照（遠中近）</strong>
    <p style="font-size: 0.9em; color: #666; line-height: 1.4;">上傳個人照片，選擇喜愛的季節，創作一幅包含遠中近充滿韓劇電影感的藝術照片</p>
...
<td width="33%" valign="top">
  ...
  <div style="padding: 10px 0;">
    <span style="font-size: 0.8em; background: #f0f0f0; padding: 2px 6px; border-radius: 4px;">圖片</span><br>
    <strong style="font-size: 1.1em; display: block; margin-top: 5px;">🖼️ 韓劇感的個人藝術照（單張）</strong>
    <p style="font-size: 0.9em; color: #666; line-height: 1.4;">上傳個人照片，選擇喜愛的季節，創作一幅充滿韓劇電影感的個人藝術照片。</p>
